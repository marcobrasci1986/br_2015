...
<!-- VISIE BLOCK 1-->
<div class="container-fluid visieBlock visie1 border-bottom-grey">
    <div class="row">
        <div class="breeze-block col-xs-8 col-xs-offset-2 col-lg-8 col-lg-offset-2">
    ...
    <div class="row">
        <div class="breeze-block col-xs-8 col-xs-offset-2 col-sm-8 col-sm-offset-2 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
            ...
            <div class="calendar-items">
                <div class="col-xs-6 col-sm-3 calender-item white">
                    <div>
...
<div class="container-fluid artikels special-bg">
    <div class="row">
        <div class="breeze-block col-xs-8 col-xs-offset-2 col-sm-8 col-sm-offset-2 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
            <div class="arrowBlock text-center">
                <h1>Onze artikels</h1>
...
<div class="container-fluid breezefm-block-2">
            ...
            <div class="col-xs-8 col-xs-offset-2 col-sm-3 col-sm-offset-2">
                <a class="various fancybox.iframe" href="http://www.youtube.com/embed/L9szn1QQfas?autoplay=1&showinfo=0">
                    <div class="video-img-wrapper">
                        ...
                        <div class="video-play-breeze-fm-block video-play-color centerAbsolute"></div>
